// Navigation 2 - Updated September 23, 2024
function noop() { }
const identity = x => x;
...
// (141:10) {#each social_links as {link, icon}}
...
// (170:10) {#each social_links as {link, icon}}
