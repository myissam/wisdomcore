// Navigation 2 - Updated October 12, 2024
function noop() { }
const identity = x => x;
...
function create_each_block_5(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "nav-item svelte-1c4ybcy");
...
function create_each_block_4(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "button svelte-1c4ybcy");
			attr(a, "href", a_href_value = /*link*/ ctx[9].url);
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
...
// (150:10) {#each social_links as {link, icon}}
function create_each_block_3(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = /*link*/ ctx[9].url);
			attr(a, "aria-label", a_aria_label_value = /*icon*/ ctx[10]);
			attr(a, "class", "svelte-1c4ybcy");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			const icon_changes = {};
			if (dirty & /*social_links*/ 8) icon_changes.icon = /*icon*/ ctx[10];
			icon.$set(icon_changes);

			if (!current || dirty & /*social_links*/ 8 && a_href_value !== (a_href_value = /*link*/ ctx[9].url)) {
				attr(a, "href", a_href_value);
			}

			if (!current || dirty & /*social_links*/ 8 && a_aria_label_value !== (a_aria_label_value = /*icon*/ ctx[10])) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(hr, "class", "svelte-1c4ybcy");
			attr(button, "id", "close");
			attr(button, "aria-label", "Close Navigation");
			attr(button, "class", "svelte-1c4ybcy");
			attr(nav, "id", "mobile-nav");
			attr(nav, "class", "svelte-1c4ybcy");
		},
		m(target, anchor) {
...
// (179:10) {#each social_links as {link, icon}}
...
function create_fragment(ctx) {
	...
	let each_value_5 = /*site_nav*/ ctx[2];
	let each_blocks_2 = [];
	...
	let each_value_3 = /*social_links*/ ctx[3];
	let each_blocks = [];
	...
	return {
		...
		h() {
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-1c4ybcy");
			set_style(a, "--size", style___size);
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(button, "class", "svelte-1c4ybcy");
			attr(nav, "class", "svelte-1c4ybcy");
			attr(div0, "class", "desktop-nav svelte-1c4ybcy");
			attr(div1, "class", "section-container svelte-1c4ybcy");
			attr(header, "class", "svelte-1c4ybcy");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*social_links*/ 8) {
				each_value_3 = /*social_links*/ ctx[3];
				let i;
